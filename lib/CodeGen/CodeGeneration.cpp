...
public:
  ...
  bool runOnScop(Scop &S) override {
    ...
    llvm::errs() << "CodeGeneration::runOnScop running on " << S.getName() << '\n';
    if (S.isToBeSkipped("CodeGeneration::runOnScop"))
      return false;
    ...
    bool isModified = CodeGen(S, *AI, *LI, *DT, *SE, *RI);
    if(isModified)
      llvm::errs() << "CodeGeneration::runOnScop code-generated " << S.getName() << '\n';
    return isModified;
  }
