...
; KERNEL: define ptx_kernel void @foo_b1---b8_kernel_0(i8 addrspace(1)* %MemRef_A, i64 %n) #0 {

; KERNEL: !nvvm.annotations = !{!0}

; KERNEL: !0 = !{void (i8 addrspace(1)*, i64)* @foo_b1---b8_kernel_0, !"maxntidx", i32 32, !"maxntidy", i32 1, !"maxntidz", i32 1}
