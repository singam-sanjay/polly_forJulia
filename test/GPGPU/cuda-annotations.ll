...
; KERNEL: define ptx_kernel void @FUNC_foo_SCOP_bb1_bb8_KERNEL_0(i8 addrspace(1)* %MemRef_A, i64 %n) #0 {

; KERNEL: !nvvm.annotations = !{!0}

; KERNEL: !0 = !{void (i8 addrspace(1)*, i64)* @FUNC_foo_SCOP_bb1_bb8_KERNEL_0, !"maxntidx", i32 32, !"maxntidy", i32 1, !"maxntidz", i32 1}
