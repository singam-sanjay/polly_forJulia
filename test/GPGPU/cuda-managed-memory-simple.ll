...
; CHECK-NEXT:  %24 = call i8* @polly_getKernel(i8* getelementptr inbounds ([780 x i8], [780 x i8]* @copy_kernel_0, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @copy_kernel_0_name, i32 0, i32 0))
