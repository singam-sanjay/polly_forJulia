...
; KERNEL: define ptx_kernel void @kernel_params_only_some_arrays_kernel_0(i8 addrspace(1)* %MemRef_A)
; KERNEL-NEXT:   entry:
...
; KERNEL: define ptx_kernel void @kernel_params_only_some_arrays_kernel_1(i8 addrspace(1)* %MemRef_B)
; KERNEL-NEXT:   entry:
; KERNEL-NEXT:     %0 = call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x()
; KERNEL-NEXT:     %b0 = zext i32 %0 to i64
; KERNEL-NEXT:     %1 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x()
